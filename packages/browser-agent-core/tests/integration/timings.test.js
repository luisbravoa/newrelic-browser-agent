...
import { setInfo } from "../../common/config/config"
...
test('page-view-timing serializer default attributes', done => {
...
test('page-view-timing serializer handles custom attributes', done => {
