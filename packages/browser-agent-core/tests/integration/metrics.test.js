...
import { Instrument as MetricsInstrum, constants } from '../../features/metrics/instrument/index'
...
test('recordSupportability with no value creates a metric with just a count', done => {
...
test('recordSupportability with no value increments multiple times correctly', done => {
  createAndStoreMetric()
  createAndStoreMetric()
  createAndStoreMetric()
...
test('recordSupportability with a value aggregates stats section', done => {
...
test('recordSupportability with a value aggregates stats section and increments correctly', done => {
...
test('recordSupportability does not create a customMetric (cm) item', done => {
...
test('recordCustom with no value creates a metric with just a count', done => {
...
test('recordCustom with no value increments multiple times correctly', done => {
  createAndStoreMetric(undefined, false)
  createAndStoreMetric(undefined, false)
  createAndStoreMetric(undefined, false)
...
test('recordCustom with a value creates a named metric object in metrics section', done => {
...
test('recordCustom with a value creates a named metric object in metrics section and increments correctly', done => {
  const values = [Math.random(), Math.random(), Math.random()]
...
test('recordCustom with an invalid value type does not create a named metric object in metrics section', done => {
...
test('recordCustom does not create a supportabilityMetric (sm) item', done => {
  createAndStoreMetric(Math.random(), false)
  try {
    const record = agg.take([sLabel])[sLabel]
    t.ok(record, JSON.stringify(record))
